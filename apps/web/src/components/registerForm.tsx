        ...
        return (
          <Form>
            <div className="mt-10 min-w-[30vw] min-h-[450px]">
              <h2 className="text-2xl text-center font-bold leading-7 text-gray-900">
                Sign up
              </h2>
              ...
              <button
                type="submit"
                className="w-full mt-6 p-1.5 text-sm font-medium rounded-md bg-secondary text-white hover:bg-slate-500 "
              >
                Register
              </button>
            </div>
